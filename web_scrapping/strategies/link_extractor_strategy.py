...
class LinkExtractorStrategy(ExtractorStrategy):
    """Strategy for extracting job links from a saved HTML page"""
    
    def extract(self, file_name: str, data: dict = None) -> Dict[str, str]:
        """
        Extract job links from HTML page
        
        Args:
            source: Path to HTML file
            
        Returns:
            Dict mapping job titles to their LinkedIn paths
        """
